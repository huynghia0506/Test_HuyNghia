...
def cal_med_z(file_list, column_name='arm_acc_z'):
    data_frames = []
...
med_1_0 = cal_med_z(file_1_0)
med_2_0 = cal_med_z(file_2_0)


med_1_1 = cal_med_z(file_1_1)
med_2_1 = cal_med_z(file_2_1)


med_1_2 = cal_med_z(file_1_2)
med_2_2 = cal_med_z(file_2_2)



print("KẾT QUẢ TÍNH MEDIAN CỦA arm_acc_z")
